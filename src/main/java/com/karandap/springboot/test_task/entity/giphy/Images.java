...
package com.karandap.springboot.test_task.entity.giphy;
...
public class Images {
    ...
    private The480wStill _480wStill;
    @JsonIgnore
    ...
    @JsonProperty("480w_still")
    public The480wStill get480wStill() {
        return _480wStill;
    }

    @JsonProperty("480w_still")
    public void set480wStill(The480wStill _480wStill) {
